...
export const options = {
  ...
  thresholds:{
    http_req_duration: ['p(95)<1000'],//el 95% de las respuestas <500ms
...
export default function () {
  ...
  check(res, {
    ...
    'time<1000ms':(r)=>r.timings.duration <1000
  });
...
//k6 run --out experimental-prometheus-rw=http://localhost:9090/api/v1/write C:\Users\Veronica\Desktop\POSGRADO\SegundoSemestre\TrabajoDeTitulacion\code\circuit-breaker-system\performance-test\2simulate-latency-without-circuit-breaker.js